...
model = YOLO("/work/mbergst/TDT4265_Project/runs/keypoints/1_train-val_1min_aalesund_from_start/changed-shear-perspective/weights/best.pt")

model.predict("/work/mbergst/TDT4265_Project/data_yolov8/keypoint_detection/1_train-val_1min_aalesund_from_start/images/train/000721.jpg", save = True, project = "/work/mbergst/TDT4265_Project/runs/keypoints/1_train-val_1min_aalesund_from_start", imgsz = (1280), line_width = 1)
